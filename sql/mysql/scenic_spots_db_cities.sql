...
--
-- Host: localhost    Database: scenic_spots_db
-- ------------------------------------------------------
...
CREATE TABLE `cities` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`,`province_id`) COMMENT '确保城市在省份内唯一',
...
INSERT INTO `cities` VALUES (23,'上海市',34),(1,'北京市',11),(21,'广州市',35),(22,'深圳市',35),(24,'西安市',36);
