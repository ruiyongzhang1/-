...
def is_travel_planning_request(message: str) -> bool:
    ...
    travel_keywords = [
    # 🟣 核心旅行
    '旅行', '旅游', '行程', '出行', '规划', '计划', '攻略', '游记',

    # 🟡 交通出行
    '机票', '航班', '高铁', '动车', '火车', '车票', '租车', '包车', '自驾', '地铁', '公交', '轮渡', '船票',

    # 🟢 住宿相关
    '酒店', '住宿', '民宿', '客栈', '青旅', '床位', '营地', '露营', '帐篷',

    # 🔵 景点游玩
    '景点', '路线', '景区', '门票', '打卡', '必去', '观光', '地标', '古镇', '老街', '海岛', '沙滩', '雪山', '草原', '温泉',

    # 🟠 美食推荐
    '美食', '小吃', '特产', '餐厅', '夜市', '街边', '米其', '菜系', '烧烤', '火锅', '海鲜',

    # 🟤 主题玩法
    '自由', '跟团', '定制', '自驾', '露营', '登山', '徒步', '滑雪', '骑行', '潜水', '跳伞', '漂流', '探店', '夜游', '拍照', '摄影', '蜜月', '亲子', '团建',

    # 🟣 假期类型
    '度假', '休闲', '出境', '海外', '国内', '短途', '周边', '长线',

    # 🟡 娱乐购物
    '夜店', '酒吧', '剧院', '表演', '商圈', '购物', '奢购', '免税',

    # 🟢 季节活动
    '避暑', '赏花', '秋游', '春游', '滑雪', '泡汤', '跨年', '元旦', '春节',

    # 🟠 人群标签
    '情侣', '亲子', '闺蜜', '家庭', '朋友', '单人', '团建',

    # 🔴 其他
    '签证', '特价', '折扣', '预定', '退票', '改签',

    # 🌧️ 天气相关
    '天气', '气温', '温度', '降雨', '降雪', '雨量', '风力', '风速', '雷雨', '暴雨',
    '大雪', '小雪', '阴天', '晴天', '多云', '雾霾', '台风', '寒潮', '热浪', '干旱',
    '紫外', '湿度', '日晒', '夜温', '气候', '预报'
]
